...
public class ShakeDetector {
    ...
    static boolean isAvailableA;
    static boolean isAvailableV;

    public ShakeDetector(){
       isAvailableV = Gdx.input.isPeripheralAvailable(Input.Peripheral.Accelerometer);
       isAvailableV = Gdx.input.isPeripheralAvailable(Input.Peripheral.Vibrator);
    }
